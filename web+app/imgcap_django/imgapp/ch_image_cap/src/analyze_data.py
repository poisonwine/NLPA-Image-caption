...
from src.config import train_folder, train_annotations_filename

if __name__ == '__main__':
    print('Calculating the maximum length among all the captions')#计算所有描述中的最大长度
    annotations_path = '/home/ydy/data/DY_young-Image-Caption-master/ch_image_cap/data/train_data/caption_train_annotations_20170902.json'#训练集标注文件路径
