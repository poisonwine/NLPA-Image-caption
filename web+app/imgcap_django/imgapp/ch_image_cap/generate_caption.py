...
def generate_caption(img_path):
    ...
    channel = 3
    # 设置模型权重的地址
    # model_weights_path = os.path.join('/home/anna/pycharm_proj/imgcap_django/imgapp/ch_image_cap/models', best_model)
    # print('模型加载中...')
    # # 创建模型
    # model = build_model()
    # # 加载模型权重
    ...
    # print('模型加载完毕...')
    model = load_model('/home/anna/pycharm_proj/imgcap_django/imgapp/ch_image_cap/caption_model.h5')
    # print(model.summary())
    #加载语料库
    vocab = pickle.load(open('/home/anna/pycharm_proj/imgcap_django/imgapp/ch_image_cap/data/vocab_train.p', 'rb'))
...
def test():
    url = '/home/anna/pycharm_proj/imgcap_django' + '/media/upload/tmp_198db79c388f09117018c9d558f6c46ab48382a19c27b504.jpg'
    sentence = generate_caption(url)
    print(sentence)

# if __name__ =='__main__':
#     url = '/home/anna/pycharm_proj/imgcap_django' + '/media/upload/tmp_198db79c388f09117018c9d558f6c46ab48382a19c27b504.jpg'
#     image_path = 'data/ai_challenger_caption_test_a_20180103/caption_test_a_images_20180103/0.jpg'
#     sentence = generate_caption(url)