...
from src.config import train_image_folder, valid_image_folder, test_a_image_folder, test_b_image_folder, flicker_image_folder,test_valid_path
...
def encode_images(usage):
    ...
    #编码测试集a
        ...
        image_folder = flicker_image_folder
    #编码测试集b
    elif usage == 'test_valid':
        image_folder = test_valid_path
    else:  # usage == 'test_b':
...
def test_gen():
    encode_images('test_a')
def test_flicker():
    encode_images('flicker')
def test_valid():
    encode_images('test_valid')